...
const Earnings = () => {
  ...
  const getTransactionIcon = (type) => {
    switch(type) {
      ...
      case "commission": return <FaCoins className="text-green-600" />;
      case "task": return <FaCheckCircle className="text-purple-600" />;
      case "withdrawal": return <FaUniversity className="text-red-600" />;
      case "bonus": return <FaGift className="text-orange-600" />;
                    ...
                    <tr key={transaction.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        ...
                        {transaction.relatedUser && (
                          <div className="text-xs text-gray-500">Related: {transaction.relatedUser}</div>
                        )}
                        {transaction.level && (
